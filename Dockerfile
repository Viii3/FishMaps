...
RUN echo 'create-jms-resource --restype jakarta.jms.ConnectionFactory jms/ConnectionFactory'
RUN echo 'create-jms-resource --restype jakarta.jms.Topic --property Name=BlockTopic jms/BlockTopic'